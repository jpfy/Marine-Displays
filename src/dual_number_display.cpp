...
void dual_number_display_create(int screen_num) {
    ...
    lv_obj_set_style_bg_opa(dual_containers[screen_num], LV_OPA_TRANSP, 0);
    ...
    if (bg_image == "Custom Color") {
        ...
        lv_obj_set_style_bg_color(dual_bg_panels[screen_num], parse_hex_color(cfg.number_bg_color), 0);
    ...
    dual_top_description_labels[screen_num] = lv_label_create(dual_containers[screen_num]);
    ...
    lv_obj_set_style_text_color(dual_top_description_labels[screen_num], parse_hex_color(cfg.dual_top_font_color), 0);
    ...
    dual_top_labels[screen_num] = lv_label_create(dual_containers[screen_num]);
    ...
    lv_obj_set_style_text_font(dual_top_labels[screen_num], get_font_for_size(cfg.dual_top_font_size), 0);
    lv_obj_set_style_text_color(dual_top_labels[screen_num], parse_hex_color(cfg.dual_top_font_color), 0);
    ...
    lv_obj_set_style_transform_zoom(dual_top_labels[screen_num], get_zoom_for_size(cfg.dual_top_font_size), 0);
    ...
    dual_top_unit_labels[screen_num] = lv_label_create(dual_containers[screen_num]);
    ...
    lv_obj_set_style_text_color(dual_top_unit_labels[screen_num], parse_hex_color(cfg.dual_top_font_color), 0);
    ...
    dual_bottom_description_labels[screen_num] = lv_label_create(dual_containers[screen_num]);
    ...
    lv_obj_set_style_text_color(dual_bottom_description_labels[screen_num], parse_hex_color(cfg.dual_bottom_font_color), 0);
    ...
    dual_bottom_labels[screen_num] = lv_label_create(dual_containers[screen_num]);
    ...
    lv_obj_set_style_text_font(dual_bottom_labels[screen_num], get_font_for_size(cfg.dual_bottom_font_size), 0);
    lv_obj_set_style_text_color(dual_bottom_labels[screen_num], parse_hex_color(cfg.dual_bottom_font_color), 0);
    ...
    lv_obj_set_style_transform_zoom(dual_bottom_labels[screen_num], get_zoom_for_size(cfg.dual_bottom_font_size), 0);
    ...
    dual_bottom_unit_labels[screen_num] = lv_label_create(dual_containers[screen_num]);
    ...
    lv_obj_set_style_text_color(dual_bottom_unit_labels[screen_num], parse_hex_color(cfg.dual_bottom_font_color), 0);
