...
void quad_number_display_create(int screen_num) {
    ...
    // Remove padding and make container transparent (background will be added conditionally)
    lv_obj_set_style_pad_all(quad_containers[screen_num], 0, 0);
    lv_obj_set_style_bg_opa(quad_containers[screen_num], LV_OPA_TRANSP, 0);
    lv_obj_set_style_border_width(quad_containers[screen_num], 0, 0);
    lv_obj_set_style_radius(quad_containers[screen_num], 0, 0);
    
    // Handle background based on background_path field (like number_display does)
    ...
    if (bg_image == "Custom Color") {
        ...
        lv_obj_set_style_bg_color(quad_bg_panels[screen_num], parse_hex_color(cfg.number_bg_color), 0);
    ...
    const lv_font_t* small_font = &inter_16;  // For descriptions
    const lv_font_t* unit_font = &inter_24;   // For units
    
    // TOP-LEFT QUADRANT (0-240, 0-240)
    // Description label (top-left corner of TL quadrant)
    quad_tl_description_labels[screen_num] = lv_label_create(quad_containers[screen_num]);
    ...
    lv_obj_set_style_text_color(quad_tl_description_labels[screen_num], parse_hex_color(cfg.quad_tl_font_color), 0);
    ...
    quad_tl_labels[screen_num] = lv_label_create(quad_containers[screen_num]);
    ...
    lv_obj_set_style_text_font(quad_tl_labels[screen_num], get_font_for_size(cfg.quad_tl_font_size), 0);
    lv_obj_set_style_text_color(quad_tl_labels[screen_num], parse_hex_color(cfg.quad_tl_font_color), 0);
    ...
    lv_obj_set_style_transform_zoom(quad_tl_labels[screen_num], font_size_to_zoom(cfg.quad_tl_font_size), 0);
    ...
    quad_tl_unit_labels[screen_num] = lv_label_create(quad_containers[screen_num]);
    lv_label_set_text(quad_tl_unit_labels[screen_num], "");
    lv_obj_set_size(quad_tl_unit_labels[screen_num], 100, 36);  // Increased height for 24pt font
    ...
    lv_obj_set_style_text_font(quad_tl_unit_labels[screen_num], unit_font, 0);
    lv_obj_set_style_text_color(quad_tl_unit_labels[screen_num], parse_hex_color(cfg.quad_tl_font_color), 0);
    ...
    quad_tr_description_labels[screen_num] = lv_label_create(quad_containers[screen_num]);
    ...
    lv_obj_set_style_text_color(quad_tr_description_labels[screen_num], parse_hex_color(cfg.quad_tr_font_color), 0);
    ...
    quad_tr_labels[screen_num] = lv_label_create(quad_containers[screen_num]);
    ...
    lv_obj_set_style_text_font(quad_tr_labels[screen_num], get_font_for_size(cfg.quad_tr_font_size), 0);
    lv_obj_set_style_text_color(quad_tr_labels[screen_num], parse_hex_color(cfg.quad_tr_font_color), 0);
    ...
    lv_obj_set_style_transform_zoom(quad_tr_labels[screen_num], font_size_to_zoom(cfg.quad_tr_font_size), 0);
    ...
    quad_tr_unit_labels[screen_num] = lv_label_create(quad_containers[screen_num]);
    lv_label_set_text(quad_tr_unit_labels[screen_num], "");
    lv_obj_set_size(quad_tr_unit_labels[screen_num], 100, 36);  // Increased height for 24pt font
    ...
    lv_obj_set_style_text_font(quad_tr_unit_labels[screen_num], unit_font, 0);
    lv_obj_set_style_text_color(quad_tr_unit_labels[screen_num], parse_hex_color(cfg.quad_tr_font_color), 0);
    ...
    quad_bl_description_labels[screen_num] = lv_label_create(quad_containers[screen_num]);
    ...
    lv_obj_set_style_text_color(quad_bl_description_labels[screen_num], parse_hex_color(cfg.quad_bl_font_color), 0);
    ...
    quad_bl_labels[screen_num] = lv_label_create(quad_containers[screen_num]);
    ...
    lv_obj_set_style_text_font(quad_bl_labels[screen_num], get_font_for_size(cfg.quad_bl_font_size), 0);
    lv_obj_set_style_text_color(quad_bl_labels[screen_num], parse_hex_color(cfg.quad_bl_font_color), 0);
    ...
    lv_obj_set_style_transform_zoom(quad_bl_labels[screen_num], font_size_to_zoom(cfg.quad_bl_font_size), 0);
    ...
    quad_bl_unit_labels[screen_num] = lv_label_create(quad_containers[screen_num]);
    lv_label_set_text(quad_bl_unit_labels[screen_num], "");
    lv_obj_set_size(quad_bl_unit_labels[screen_num], 100, 36);  // Increased height for 24pt font
    ...
    lv_obj_set_style_text_font(quad_bl_unit_labels[screen_num], unit_font, 0);
    lv_obj_set_style_text_color(quad_bl_unit_labels[screen_num], parse_hex_color(cfg.quad_bl_font_color), 0);
    ...
    quad_br_description_labels[screen_num] = lv_label_create(quad_containers[screen_num]);
    ...
    lv_obj_set_style_text_color(quad_br_description_labels[screen_num], parse_hex_color(cfg.quad_br_font_color), 0);
    ...
    quad_br_labels[screen_num] = lv_label_create(quad_containers[screen_num]);
    ...
    lv_obj_set_style_text_font(quad_br_labels[screen_num], get_font_for_size(cfg.quad_br_font_size), 0);
    lv_obj_set_style_text_color(quad_br_labels[screen_num], parse_hex_color(cfg.quad_br_font_color), 0);
    ...
    lv_obj_set_style_transform_zoom(quad_br_labels[screen_num], font_size_to_zoom(cfg.quad_br_font_size), 0);
    ...
    quad_br_unit_labels[screen_num] = lv_label_create(quad_containers[screen_num]);
    lv_label_set_text(quad_br_unit_labels[screen_num], "");
    lv_obj_set_size(quad_br_unit_labels[screen_num], 100, 36);  // Increased height for 24pt font
    ...
    lv_obj_set_style_text_font(quad_br_unit_labels[screen_num], unit_font, 0);
    lv_obj_set_style_text_color(quad_br_unit_labels[screen_num], parse_hex_color(cfg.quad_br_font_color), 0);
