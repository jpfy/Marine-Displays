...
#define ESP_PANEL_LCD_RGB_TIMING_FREQ_HZ          (8 * 1000 * 1000)   // 8MHz pixel clock for stability
...
#define ESP_PANEL_LCD_RGB_FRAME_BUF_NUM           (2)     // 2 framebuffers for direct mode
#define ESP_PANEL_LCD_RGB_BOUNCE_BUF_SIZE         (0)     // Disable bounce buffer
