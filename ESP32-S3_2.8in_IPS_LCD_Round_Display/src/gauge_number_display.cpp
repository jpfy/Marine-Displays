...
// Inter font declarations (font .c files compiled alongside)
extern const lv_font_t inter_16;
extern const lv_font_t inter_24;
extern const lv_font_t inter_48;
extern const lv_font_t inter_72;
extern const lv_font_t inter_96;
extern const lv_font_t inter_120;
extern const lv_font_t inter_144;
...
static char prev_gauge_num_center_text[NUM_SCREENS][64];
static char prev_gauge_num_center_unit[NUM_SCREENS][32];
static char prev_gauge_num_center_description[NUM_SCREENS][128];
...
void gauge_number_display_create(int screen_num, 
    ...
    lv_obj_set_size(gauge_num_containers[screen_num], 480, 480);
    ...
    lv_obj_clear_flag(gauge_num_containers[screen_num], LV_OBJ_FLAG_CLICKABLE);
    ...
    lv_obj_set_style_transform_zoom(gauge_num_center_labels[screen_num], 256, 0);
    ...
    lv_obj_set_style_text_font(gauge_num_center_unit_labels[screen_num], &inter_48, 0);
...
void gauge_number_display_update_center(int screen_num, float value, const char* unit, const char* description) {
    ...
    // Re-align number and unit whenever either changes
    if (needs_update) {
        lv_obj_align(gauge_num_center_labels[screen_num], LV_ALIGN_CENTER, -20, 0);
        lv_obj_align_to(gauge_num_center_unit_labels[screen_num], gauge_num_center_labels[screen_num], LV_ALIGN_OUT_RIGHT_MID, 10, 0);
    }
